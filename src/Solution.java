...
public class Solution
{
    ...
    // Crea una clase NIF que represente el DNI con su correspondiente letra. Los atributos de la clase serán
    ...
    //Un método leer(): que pida por teclado el número de DNI y calcule a partir del DNI introducido la letra que
    // le corresponde.
    //Método toString() que muestre el NIF de la siguiente forma: ocho dígitos, un guión y la letra en mayúscula.
